<?php
 ...
 ?>
<div id="bgTOS">
    <div id="bgTOSCabecalho">
        <div id="bgTOSCabecalhoTitulo">
            <span>Termos de Uso</span>
        </div>
        <div id="bgTOSCabecalhoFechar">
            <span onclick="fecharModalTOS()">X</span>
        </div>
    </div>
    ...
    <div id="registroBox">
        <div id="registro">
            ...
            <table id="tblRegistroUsuario3">
                ...
                <tr>
                    <td><span>Ao registrar aceito aos <span onclick="abrirModalTOS()">termos e condições de uso</span>.</span></td>
                </tr>
                <tr>
            ...
            <form action="router.php?controller=parceiro&modo=inserir" method="post">
                ...
                <table id="tblRegistroParceiro3">
                    ...
                    <tr>
                        <td><span>Ao registrar aceito aos <span onclick="abrirModalTOS()">termos e condições de uso</a>.</span></td>
                    </tr>
                    <tr>
